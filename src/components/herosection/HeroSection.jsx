...
function HeroSection() {
  return (
    <div className="relative h-screen  flex flex-col-reverse items-center bg-gradient-to-br from-blue-300 to-blue-900/50 rounded-ee-full lg:pt-20 lg:flex-row">
      <BackgroundBeams />
