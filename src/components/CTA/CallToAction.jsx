  ...
  return (
    <>
      <div className="relative py-20 lg:py-28 ">
        {/* body */}
        <div className="w-[86%] bg-gradient-to-r from-indigo-500 to-purple-500 space-y-6 m-auto text-center px-8 py-8 rounded-3xl lg:w-[94%] lg:py-32 lg:space-y-10">
          {/* main */}
          <div className="space-y-8 lg:space-y-16">
            <h3 className="text-xl lg:text-4xl font-poetsen">
              You can grow faster than you think!
            </h3>
            <p className="text-center lg:w-[55%] lg:m-auto font-mono">
